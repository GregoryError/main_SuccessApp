...
{
    m_javaClass = QAndroidJniObject("com/success/android/firebasetest/ListenerService");
...
QJsonArray NotificationWorker::getEvents()
{
    ...
    QStringList list = events.toString().split(";", QString::SkipEmptyParts);
    QJsonArray arr;
